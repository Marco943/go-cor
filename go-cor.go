...
func main() {
	...
	containerCoresSalvas := container.NewGridWithColumns(1,
		widget.NewLabel("Cores Salvas"),
		container.NewStack(
			widget.NewButton("#ff0000", func() {}),
			canvas.NewRectangle(color.NRGBA{R: 255, G: 0, B: 0, A: 255}),
		),
	)
